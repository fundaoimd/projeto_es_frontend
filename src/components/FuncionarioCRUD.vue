...
const fetchEmployees = async() => {
  try {
    ...
    alert('Erro ao carregar lista. Verifique se o servidor Django está rodando.');
  }
};
      ...
      <table class="crud-table">
        ...
        <tbody>
          ...
          <tr v-for="employee in employees" :key="employee.id">
            ...
            <td>{{ employee.role }}</td>
            <td class="actions">
              <button @click="handleEdit(employee)" class="btn-edit">Editar</button>
              <button class="btn-delete" @click="handleDelete(employee.id)">Apagar</button>
            </td>
          </tr>
        </tbody>
      </table>
